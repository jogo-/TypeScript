...
fileExists:: {
 ...
 "/src/third/thirdjs/output/third-output.d.ts.map": 1,
 "/src/third/thirdjs/output/third-output.tsbuildinfo": 2
}
...
2 >Emitted(16, 19) Source(14, 19) + SourceIndex(3)
3 >Emitted(16, 20) Source(14, 20) + SourceIndex(3)
---
>>>    }
1 >^^^^
2 >    ^
...
2 >Emitted(18, 19) Source(16, 19) + SourceIndex(3)
3 >Emitted(18, 20) Source(16, 20) + SourceIndex(3)
4 >Emitted(18, 44) Source(16, 26) + SourceIndex(3)
5 >Emitted(18, 47) Source(16, 20) + SourceIndex(3)
6 >Emitted(18, 61) Source(16, 31) + SourceIndex(3)
7 >Emitted(18, 62) Source(16, 32) + SourceIndex(3)
---
>>>    Object.defineProperty(normalC.prototype, "c", {
1 >^^^^
2 >    ^^^^^^^^^^^^^^^^^^^^^^
...
2 >Emitted(20, 23) Source(17, 19) + SourceIndex(3)
3 >Emitted(20, 29) Source(17, 20) + SourceIndex(3)
4 >Emitted(20, 43) Source(17, 30) + SourceIndex(3)
5 >Emitted(20, 50) Source(17, 37) + SourceIndex(3)
6 >Emitted(20, 52) Source(17, 39) + SourceIndex(3)
7 >Emitted(20, 53) Source(17, 40) + SourceIndex(3)
8 >Emitted(20, 54) Source(17, 41) + SourceIndex(3)
9 >Emitted(20, 55) Source(17, 42) + SourceIndex(3)
---
>>>        /**@internal*/ set: function (val) { },
1 >^^^^^^^^
2 >        ^^^^^^^^^^^^^^
...
2 >Emitted(21, 23) Source(18, 19) + SourceIndex(3)
3 >Emitted(21, 29) Source(18, 20) + SourceIndex(3)
4 >Emitted(21, 39) Source(18, 26) + SourceIndex(3)
5 >Emitted(21, 42) Source(18, 37) + SourceIndex(3)
...
2 >Emitted(29, 19) Source(21, 19) + SourceIndex(3)
3 >Emitted(29, 20) Source(21, 20) + SourceIndex(3)
---
>>>        function C() {
1->^^^^^^^^
2 >        ^^->
...
2 >Emitted(35, 19) Source(22, 19) + SourceIndex(3)
3 >Emitted(35, 20) Source(22, 20) + SourceIndex(3)
4 >Emitted(35, 29) Source(22, 36) + SourceIndex(3)
5 >Emitted(35, 32) Source(22, 39) + SourceIndex(3)
6 >Emitted(35, 37) Source(22, 43) + SourceIndex(3)
7 >Emitted(35, 38) Source(22, 44) + SourceIndex(3)
---
>>>    normalN.foo = foo;
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(37, 19) Source(23, 19) + SourceIndex(3)
3 >Emitted(37, 20) Source(23, 20) + SourceIndex(3)
4 >Emitted(37, 24) Source(23, 37) + SourceIndex(3)
5 >Emitted(37, 37) Source(23, 50) + SourceIndex(3)
6 >Emitted(37, 38) Source(23, 72) + SourceIndex(3)
---
>>>    (function (someNamespace) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(59, 19) Source(27, 19) + SourceIndex(3)
3 >Emitted(59, 20) Source(27, 33) + SourceIndex(3)
4 >Emitted(59, 41) Source(27, 46) + SourceIndex(3)
5 >Emitted(59, 44) Source(27, 49) + SourceIndex(3)
6 >Emitted(59, 46) Source(27, 51) + SourceIndex(3)
7 >Emitted(59, 47) Source(27, 52) + SourceIndex(3)
---
>>>    /**@internal*/ var internalEnum;
1 >^^^^
2 >    ^^^^^^^^^^^^^^
...
2 >Emitted(60, 19) Source(28, 19) + SourceIndex(3)
3 >Emitted(60, 20) Source(28, 20) + SourceIndex(3)
4 >Emitted(60, 24) Source(28, 32) + SourceIndex(3)
5 >Emitted(60, 36) Source(28, 56) + SourceIndex(3)
---
>>>    (function (internalEnum) {
1 >^^^^
2 >    ^^^^^^^^^^^
...
2 >Emitted(67, 15) Source(30, 15) + SourceIndex(3)
3 >Emitted(67, 16) Source(30, 16) + SourceIndex(3)
---
>>>    function internalC() {
1->^^^^
2 >    ^^->
...
2 >Emitted(82, 15) Source(33, 15) + SourceIndex(3)
3 >Emitted(82, 16) Source(33, 16) + SourceIndex(3)
4 >Emitted(82, 20) Source(33, 26) + SourceIndex(3)
5 >Emitted(82, 33) Source(33, 39) + SourceIndex(3)
6 >Emitted(82, 34) Source(33, 79) + SourceIndex(3)
---
>>>(function (internalOther) {
1 >
2 >^^^^^^^^^^^
...
2 >Emitted(94, 15) Source(34, 15) + SourceIndex(3)
3 >Emitted(94, 16) Source(34, 16) + SourceIndex(3)
4 >Emitted(94, 20) Source(34, 23) + SourceIndex(3)
5 >Emitted(94, 34) Source(34, 37) + SourceIndex(3)
6 >Emitted(94, 37) Source(34, 40) + SourceIndex(3)
7 >Emitted(94, 54) Source(34, 57) + SourceIndex(3)
8 >Emitted(94, 55) Source(34, 58) + SourceIndex(3)
9 >Emitted(94, 64) Source(34, 67) + SourceIndex(3)
10>Emitted(94, 65) Source(34, 68) + SourceIndex(3)
---
>>>/**@internal*/ var internalConst = 10;
1 >
2 >^^^^^^^^^^^^^^
...
2 >Emitted(95, 15) Source(36, 15) + SourceIndex(3)
3 >Emitted(95, 16) Source(36, 16) + SourceIndex(3)
4 >Emitted(95, 20) Source(36, 22) + SourceIndex(3)
5 >Emitted(95, 33) Source(36, 35) + SourceIndex(3)
6 >Emitted(95, 36) Source(36, 38) + SourceIndex(3)
7 >Emitted(95, 38) Source(36, 40) + SourceIndex(3)
8 >Emitted(95, 39) Source(36, 41) + SourceIndex(3)
---
>>>/**@internal*/ var internalEnum;
1 >
2 >^^^^^^^^^^^^^^
...
2 >Emitted(96, 15) Source(37, 15) + SourceIndex(3)
3 >Emitted(96, 16) Source(37, 16) + SourceIndex(3)
4 >Emitted(96, 20) Source(37, 21) + SourceIndex(3)
5 >Emitted(96, 32) Source(37, 45) + SourceIndex(3)
---
>>>(function (internalEnum) {
1 >
2 >^^^^^^^^^^^
...
{"bundle":{"commonSourceDirectory":"..","sourceFiles":["../first_PART1.ts","../first_part2.ts","../first_part3.ts"],"js":{"sections":[{"pos":0,"end":127,"kind":"text"}]},"dts":{"sections":[{"pos":0,"end":54,"kind":"internal"},{"pos":56,"end":172,"kind":"text"}]}},"version":"FakeTSVersion"}
...
{"bundle":{"commonSourceDirectory":"../..","sourceFiles":["../../third_part1.ts"],"js":{"sections":[{"pos":0,"end":3562,"kind":"prepend","data":"../../../2/second-output.js","texts":[{"pos":0,"end":3562,"kind":"text"}]},{"pos":3562,"end":3598,"kind":"text"}]},"dts":{"sections":[{"pos":0,"end":276,"kind":"prepend","data":"../../../2/second-output.d.ts","texts":[{"pos":0,"end":276,"kind":"text"}]},{"pos":276,"end":295,"kind":"text"}]}},"version":"FakeTSVersion"}
